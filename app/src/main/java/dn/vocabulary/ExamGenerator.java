...
public class ExamGenerator {
    ...
    public List<Vocab> getExam(String number, boolean randomize) {
        ...
        if ("Unit1chaos".equals(number)) {
            ...
            vocabs.add(new Vocab("Diktat", "etwas besonders Schönes"));
            vocabs.add(new Vocab("Diktat", "ausgedacht:"));
            vocabs.add(new Vocab("Diktat", "Sie ging mit ihrer Klasse"));
            vocabs.add(new Vocab("Diktat", "zum Eislaufen."));
            vocabs.add(new Vocab("Diktat", "In der Stadtmitte"));
            vocabs.add(new Vocab("Diktat", "befand sich nämlich"));
            vocabs.add(new Vocab("Diktat", "eine künstliche Eisfläche,"));
            vocabs.add(new Vocab("Diktat", "die zum Fahren und Spielen"));
            vocabs.add(new Vocab("Diktat", "genutzt werden konnte."));
            vocabs.add(new Vocab("Diktat", "Das Lachen"));
            vocabs.add(new Vocab("Diktat", "und laute Schreien der Klasse"));
            vocabs.add(new Vocab("Diktat", "hörte Herr Winter"));
            vocabs.add(new Vocab("Diktat", "bereits von weiter Ferne."));
            vocabs.add(new Vocab("Diktat", "Zu sehen gab es für ihn"));
            vocabs.add(new Vocab("Diktat", "manches Wunderliche,"));
            vocabs.add(new Vocab("Diktat", "als er die Eisfläche"));
            vocabs.add(new Vocab("Diktat", "für einen kurzen Besuch"));
            vocabs.add(new Vocab("Diktat", "aufsuchte."));
            vocabs.add(new Vocab("Diktat", "Zwei aus der Klasse"));
            vocabs.add(new Vocab("Diktat", "wollten nicht mitfahren."));
            vocabs.add(new Vocab("Diktat", "Die beiden sollten"));
            vocabs.add(new Vocab("Diktat", "in den nächsten Tagen"));
            vocabs.add(new Vocab("Diktat", "in ein Trainingslager fahren"));
            vocabs.add(new Vocab("Diktat", "und wollten"));
            vocabs.add(new Vocab("Diktat", "sich nicht verletzen."));
            vocabs.add(new Vocab("Diktat", "Ein kleines Mädchen"));
            vocabs.add(new Vocab("Diktat", "suchte verzweifelt:"));
            vocabs.add(new Vocab("Diktat", "Es hatte beim Toben"));
            vocabs.add(new Vocab("Diktat", "seine Mütze verloren."));
            vocabs.add(new Vocab("Diktat", "Alle sportlichen Kinder"));
            vocabs.add(new Vocab("Diktat", "hatten an diesem Tag"));
            vocabs.add(new Vocab("Diktat", "viel Spaß,"));
            vocabs.add(new Vocab("Diktat", "aber auch die ängstlichen."));
